...
interface RecurringTasksContainerProps {
  ...
  setTaskInstances: (tasks: TaskInstance[]) => void;
}

export const RecurringTasksContainer: React.FC<RecurringTasksContainerProps> = ({
  isLoading, setIsLoading, recurringTasks, setRecurringTasks, taskInstances, setTaskInstances,
}) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <RecurringTasksList recurringTasks={recurringTasks} isLoading={isLoading} />
      <TaskInstancesList taskInstances={taskInstances} isLoading={isLoading} />
    </div>
  );
};
